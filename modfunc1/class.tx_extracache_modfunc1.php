...
class tx_extracache_modfunc1 extends t3lib_extobjbase {
	...
	function main() {
		...
		$this->cacheManagementController = t3lib_div::makeInstance ( 'Tx_Extracache_Controller_CacheManagementController', $cacheDatabaseEntryRepository, $cacheFileRepository, $view);
