...
class Tx_Extracache_Configuration_ExtensionManager implements \TYPO3\CMS\Core\SingletonInterface
{
    ...
    /**
     * @var Tx_Extracache_Configuration_TypoScriptConfiguration
     */
    ...
    /**
     * @param Tx_Extracache_Configuration_TypoScriptConfiguration $typoScriptConfiguration
     */
    ...
    {
        if ($this->getTypoScriptConfiguration()->has('enableContentProcessors')) {
            return (boolean)$this->getTypoScriptConfiguration()->get('enableContentProcessors');
        }
    ...
    /**
     * @return Tx_Extracache_Configuration_TypoScriptConfiguration
     */
    private function getTypoScriptConfiguration()
    {
        if (null == $this->typoScriptConfiguration) {
            $this->typoScriptConfiguration = new Tx_Extracache_Configuration_TypoScriptConfiguration($GLOBALS['TSFE']);
        }
