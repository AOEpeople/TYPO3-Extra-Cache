...
final class Bootstrap {
	...
	static protected function initializeHooks() {
		...
		$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['clearCachePostProc'][] = PATH_tx_extracache . 'Classes/Typo3/Hooks/Tx_Extracache_Typo3_TypoScriptCache.php:&Tx_Extracache_Typo3_TypoScriptCache->clearCachePostProc';
